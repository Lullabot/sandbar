...
## Acceptance Criteria
- [ ] Make existing user and repository guidance accurate for per-VM agents, migration, remembered choices, and unified reset preservation.
- [ ] uvx --with-requirements docs/requirements.txt mkdocs build --strict exits 0; search affected docs to ensure old base-agent/preserve-Claude-only guidance replaced.
