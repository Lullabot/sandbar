...
func TestE2EHeadlessCreateRecordsManaged(t *testing.T) {
	...
	if err := doHeadlessCreate(context.Background(), reg, prov, cfg, false, false, io.Discard); err != nil {
...
func TestE2ERecreateRoundTrip(t *testing.T) {
	...
	if err := doHeadlessCreate(context.Background(), reg, prov, managedCfg, false, false, io.Discard); err != nil {
	...
	if err := doHeadlessCreate(context.Background(), reg, prov, managedCfg, true, false, io.Discard); err != nil {
	...
	err = doHeadlessCreate(context.Background(), unmanagedReg, prov, unmanagedCfg, true, false, io.Discard)
	if err == nil {
